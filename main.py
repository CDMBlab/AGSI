...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_components', type=int, default=15,
                        help='Number of feature groups for reliability modeling')
    parser.add_argument('--wasserstein_alpha', type=float, default=0.5,
                        help='Weight for cosine similarity in the combined similarity (1-alpha for Wasserstein)')
    # 自适应阈值参数
    parser.add_argument('--adaptive_threshold', action='store_true',
                        help='Use adaptive reliability threshold based on iteration and distribution')
